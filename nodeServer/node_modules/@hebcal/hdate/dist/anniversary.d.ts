import { SimpleHebrewDate } from './hdate-base';
 ...
 */
export declare function getYahrzeit(hyear: number, date: AnniversaryDate): Date | undefined;
export declare function getYahrzeitHD(hyear: number, date: AnniversaryDate): SimpleHebrewDate | undefined;
/**
 ...
 * @returns anniversary occurring in `hyear`
 */
export declare function getBirthdayOrAnniversary(hyear: number, date: AnniversaryDate): Date | undefined;
export declare function getBirthdayHD(hyear: number, date: AnniversaryDate): SimpleHebrewDate | undefined;
