 ...
 */
const hdate_base_1 = require("./hdate-base");
const greg_1 = require("./greg");
const gematriya_1 = require("./gematriya");
...
class HDate {
    ...
    constructor(day, month, year) {
        ...
        if (arguments.length === 3) {
            ...
            const d = isNumber ? (0, hdate_base_1.abs2hebrew)(abs0) : abs0;
            this.yy = d.yy;
            this.mm = d.mm;
            this.dd = d.dd;
            if (isNumber) {
     ...
     */
    isLeapYear() {
        return (0, hdate_base_1.isLeapYear)(this.yy);
    }
    /**
     ...
     */
    getTishreiMonth() {
        const nummonths = (0, hdate_base_1.monthsInYear)(this.getFullYear());
     ...
     */
    daysInMonth() {
        return (0, hdate_base_1.daysInMonth)(this.getMonth(), this.getFullYear());
    }
    /**
     ...
     */
    greg() {
        return (0, greg_1.abs2greg)(this.abs());
    }
    /**
    ...
    abs() {
        if (typeof this.rd !== 'number') {
            this.rd = (0, hdate_base_1.hebrew2abs)(this.yy, this.mm, this.dd);
        }
        return this.rd;
    }
    /**
    ...
    static hebrew2abs(year, month, day) {
        return (0, hdate_base_1.hebrew2abs)(year, month, day);
    }
    /**
     ...
     */
    getMonthName() {
        return (0, hdate_base_1.getMonthName)(this.getMonth(), this.getFullYear());
    }
    /**
    ...
    render(locale, showYear = true) {
        const locale0 = locale || locale_1.Locale.getLocaleName();
        const day = this.getDate();
        const monthName0 = locale_1.Locale.gettext(this.getMonthName(), locale0);
        const monthName = monthName0.replace(/'/g, '’');
        const nth = locale_1.Locale.ordinal(day, locale0);
    ...
    renderGematriya(suppressNikud = false) {
        ...
        const m = locale_1.Locale.gettext(this.getMonthName(), locale);
        const y = this.getFullYear();
        return (0, gematriya_1.gematriya)(d) + ' ' + m + ' ' + (0, gematriya_1.gematriya)(y);
    }
    /**
    ...
    static isLeapYear(year) {
        return (0, hdate_base_1.isLeapYear)(year);
    }
    /**
    ...
    static monthsInYear(year) {
        return (0, hdate_base_1.monthsInYear)(year);
    }
    /**
    ...
    static daysInMonth(month, year) {
        return (0, hdate_base_1.daysInMonth)(month, year);
    }
    /**
    ...
    static getMonthName(month, year) {
        return (0, hdate_base_1.getMonthName)(month, year);
    }
    /**
    ...
    static daysInYear(year) {
        return (0, hdate_base_1.daysInYear)(year);
    }
    /**
    ...
    static longCheshvan(year) {
        return (0, hdate_base_1.longCheshvan)(year);
    }
    /**
    ...
    static shortKislev(year) {
        return (0, hdate_base_1.shortKislev)(year);
    }
    /**
    ...
    static monthFromName(monthName) {
        ...
        const name = locale_1.Locale.hebrewStripNikkud(monthName);
        return (0, hdate_base_1.monthFromName)(name);
    }
    /**
    ...
    static fromGematriyaString(str, currentThousands = 5000) {
        ...
        const day = (0, gematriya_1.gematriyaStrToNum)(parts[0]);
        ...
        let year = (0, gematriya_1.gematriyaStrToNum)(yearStr);
        if (year < 1000) {
...
function getDayOfTranslation(locale) {
    ...
    const ofStr = locale_1.Locale.lookupTranslation('of', locale);
    if (ofStr) {
        return ' ' + ofStr;
    }
...
function fixDate(hd) {
    if (hd.dd < 1) {
        if (hd.mm === hdate_base_1.months.TISHREI) {
            hd.yy -= 1;
        }
        hd.dd += (0, hdate_base_1.daysInMonth)(hd.mm, hd.yy);
        hd.mm -= 1;
        fix(hd);
    }
    if (hd.dd > (0, hdate_base_1.daysInMonth)(hd.mm, hd.yy)) {
        if (hd.mm === hdate_base_1.months.ELUL) {
            hd.yy += 1;
        }
        hd.dd -= (0, hdate_base_1.daysInMonth)(hd.mm, hd.yy);
        if (hd.mm === (0, hdate_base_1.monthsInYear)(hd.yy)) {
...
function fixMonth(hd) {
    if (hd.mm === hdate_base_1.months.ADAR_II && !hd.isLeapYear()) {
        hd.mm -= 1; // to Adar I
        fix(hd);
    }
    else if (hd.mm < 1) {
        hd.mm += (0, hdate_base_1.monthsInYear)(hd.yy);
        hd.yy -= 1;
        fix(hd);
    }
    else if (hd.mm > (0, hdate_base_1.monthsInYear)(hd.yy)) {
        hd.mm -= (0, hdate_base_1.monthsInYear)(hd.yy);
        hd.yy += 1;
        fix(hd);
    }
