...
const ashkenazi_po_1 = require("./ashkenazi.po");
const he_po_1 = require("./he.po");
const noopLocale = {
...
Locale.addLocale('ashkenazi', ashkenazi_po_1.default);
Locale.addLocale('a', ashkenazi_po_1.default);
/* Hebrew with nikkud */
Locale.addLocale('he', he_po_1.default);
Locale.addLocale('h', he_po_1.default);
/* Hebrew without nikkud */
const heStrs = he_po_1.default.contexts[''];
const heNoNikud = {};
for (const [key, val] of Object.entries(heStrs)) {
    heNoNikud[key] = [Locale.hebrewStripNikkud(val[0])];
}
const poHeNoNikud = {
    headers: he_po_1.default.headers,
    contexts: { '': heNoNikud },
};
